...
public class CraftItemStack extends SourceWrapper {
	...
	public CraftItemStack() throws InstantiationException, IllegalAccessException{super(clazz.newInstance());}
	public CraftItemStack(Object instance){super(instance);}
